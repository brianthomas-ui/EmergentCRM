  ...
  return (
    <div className="space-y-5">
      <div className="flex items-end justify-between">
        <div>
          <h1 className="font-heading text-3xl font-bold tracking-tighter text-slate-900">Team</h1>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
        {team.map((m) => (
          <div key={m.id} data-testid={`team-card-${m.id}`} className="bg-white border border-slate-200 rounded-xl p-5">
            <div className="flex items-center gap-3 mb-3">
              <img src={m.avatar_url} alt="" className="w-12 h-12 rounded-xl object-cover border border-slate-200 bg-slate-100" />
              <div>
