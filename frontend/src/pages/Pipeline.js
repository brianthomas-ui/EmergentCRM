...
export default function Pipeline() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h1 className="font-heading text-3xl font-bold tracking-tighter text-slate-900">Pipeline</h1>
        ...
        {COLUMNS.map((stage) => {
          ...
          return (
            <div
              ...
              onDrop={() => onDrop(stage)}
              className="w-72 shrink-0 bg-slate-100/60 rounded-xl p-3 min-h-[520px] border border-dashed border-slate-300 flex flex-col gap-2.5"
            >
              ...
              {items.map((l) => (
                <div
                  ...
                  className="bg-white border border-slate-200 rounded-xl p-3 hover:border-slate-400 hover:shadow-sm transition-all cursor-grab active:cursor-grabbing"
                >
